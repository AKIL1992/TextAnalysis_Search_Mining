...
file = open('c:/my.xml', 'rb') #Open file in read-only and binary   
content = file.read() #Save the content of the file in a variable  
cur.execute("INSERT INTO TA.MYTABLE_BLOB VALUES(?,?,?)", ('4',content,'text/xml')) #Save the content to the table  
